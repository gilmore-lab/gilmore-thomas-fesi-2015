plot_channel_magnitudes <- function(df_chan_stats, df_moco, this_group, this_harm, cond, p_thresh, plot_titles) {
  
  df_plot <- compute_channel_vector_amplitudes(df_chan_stats, df_moco, this_harm, cond, p_thresh)
